/**
 * Versioned Tomato/Fanqie obfuscation maps.
 *
 * The first map covers the U+E3E8..U+E55B mapping used by the current
 * chapter export sample. Unknown entries are intentionally represented by
 * "?" and are never silently replaced by the decoder.
 */

export interface TomatoMapping {
  id: string;
  start: number;
  end: number;
  chars: string[];
